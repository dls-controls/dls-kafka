...
HOWEVER - I find the consumer a little more useful in this image because
it does timings and rates that do no include wait time
...
To set up a producer with message size s and message count c do this:
  /librdkafka/examples/rdkafka_performance -P -X message.max.bytes=200000000 -b kafka2-0-external.controls-kafka:9094,kafka2-1-external.controls-kafka:9094,kafka2-2-external.controls-kafka:9094 -t test3 -s 1000 -c 1000
or
